...
public class StreetViewActivity extends AppCompatActivity
    ...
    private LocationModel mRandomLocationModel =
            new LocationModel(StreetViewActivity.this);
    ...
    private LocationModel mCorrectLm = new LocationModel(StreetViewActivity.this);
    private LocationModel mUserGuessLm = new LocationModel(StreetViewActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String roundText = "Round " + RoundSharedPreferences.getCurrentRound() + " of 5";
        ...
        btnChooseLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userLocationsLat.add(currentRound - 1, String.valueOf(mUserGuessLm.getLocation().latitude));
                userLocationsLng.add(currentRound - 1, String.valueOf(mUserGuessLm.getLocation().longitude));
        ...
        btnNextRound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LocationsSharedPreferences.updateLocations(userLocationsLat, userLocationsLng,
                        correctLocationsLat,  correctLocationsLng);
                ...
                if (currentRound >= 5) {
                    ...
                    startActivity(new Intent(StreetViewActivity.this, SummaryActivity.class));

                } else {

                    startActivity(new Intent(StreetViewActivity.this, StreetViewActivity.class));
        ...
        streetViewPanorama.setOnStreetViewPanoramaChangeListener(new StreetViewPanorama.OnStreetViewPanoramaChangeListener() {
            ...
            public void onStreetViewPanoramaChange(StreetViewPanoramaLocation streetViewPanoramaLocation) {
                if  (streetViewPanoramaLocation==null || streetViewPanoramaLocation.links==null) {
                    //if the location is invalid, generate the location again and try to set it again
                    mRandomLocationModel.setLocation(mRandomLocationModel.generateRandomStreetView());
                    streetViewPanorama.setPosition(mRandomLocationModel.getLocation(), 100000, StreetViewSource.OUTDOOR);
                } else {
                    ...
                    mRandomLocationModel.getCountryByLocation();
                }
            }
        });
    }
    ...
    public void onBackPressed() {
        if (mSlidingLayout.getPanelState() == SlidingUpPanelLayout.PanelState.EXPANDED && !locationChoose) {
            ...
            startActivity(new Intent(StreetViewActivity.this, ChooseGameModeActivity.class));
        }
    }
